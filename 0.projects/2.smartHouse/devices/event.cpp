...
{
	return m_eventImp->GetType();
}

const string& Event::GetRoom() const 
{
	return m_eventImp->GetRoom();
}

const EventImp* Event::GetEventImp() const
{
	return m_eventImp;
}

unsigned int Event::GetFloor() const 
{
	return m_eventImp->GetFloor();
}
